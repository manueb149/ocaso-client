...
const initialState: ILayoutState = {
  ...
  isViewSolicitudModalOpen: false,
};
...
const layoutSlice = createSlice({
  ...
  reducers: {
    ...
    setViewSolicitudModal: (state, action: PayloadAction<boolean>) => {
      state.isViewSolicitudModalOpen = action.payload;
    },
  },
});
